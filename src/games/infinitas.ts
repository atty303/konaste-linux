...
.action(async (_options, url) => {
    ...
    const exe = `C:\\Games\\beatmania IIDX INFINITAS\\launcher\\modules\\bm2dx_launcher.exe`;
...
export const infinitasCommand = new Command()
.description("Commands for beatmania IIDX INFINITAS")
.command("info", info)
